...
@Component({
  selector: 'app-entrevistador-demografica',
  templateUrl: './entrevistador-demografica.component.html',
  styleUrls: ['./entrevistador-demografica.component.scss']
})
export class EntrevistadorDemograficaComponent {
  ...
  ngOnInit(): void {
    ...
    this.bloco = this.route.snapshot.url[3].path;
